...
**********************/
inline Algorithm::Algorithm(const std::vector<double>& solution, int solvelen)
{
...
inline void Algorithm::Set_TerminationConditions(double mincost, int maxiterate, TermCriteria type)
{
    _TermCost = mincost; _TermIterate = maxiterate; TermType = type;
}

inline void Algorithm::Solution_Print() const
{
    std::cout<<_MinCost<<": ";
